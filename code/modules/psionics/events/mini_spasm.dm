...
/datum/event/minispasm/proc/do_spasm(var/mob/living/victim, var/obj/item/device/radio/source)
	...
	var/banned_spices = list(SPECIES_ADHERENT, SPECIES_IPC, SPECIES_VOX, SPECIES_ALIEN, SPECIES_GOLEM, SPECIES_MANTID_GYNE, SPECIES_MANTID_ALATE, SPECIES_MONARCH_WORKER, SPECIES_MONARCH_QUEEN, SPECIES_XENO)
	...
	if(victim.psi)
		...
		victim.psi.update()
	sleep(45)
	victim.psi.check_latency_trigger(10, "a psionic scream", redactive = TRUE)

...
/decl/hierarchy/skill/medical/medical/virology
	ID = "virology"
	name = "Вирусология"
	desc = "Этот навык подразумевает понимание особенностей микроорганизмов и их воздействия на человека."
	levels = list( "Необученный"			= "Вы знаете, что болезни заразны; вероятно, вы слышали, что нужно мыть руки, чтобы предотвратить их распространение. Вы знаете, что если вы заболели, вы можете обратиться в медицинское учреждение и получить лечение. <br>- У вас нет лабораторной подготовки, и вы, вероятно, вызовете утечку вирусов, если попытаетесь использовать там оборудование.",
					"Обученный"				= "Вы прошли обучение по вопросам вирусологии и можете безопасно работать с оборудованием в вирусологической лаборатории. Вы можете выделять антитела и модифицировать вирусы. <br>- Можете использовать вирусологическое оборудование без риска утечки вирусов.")

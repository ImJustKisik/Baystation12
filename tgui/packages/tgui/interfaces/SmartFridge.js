    ...
    <Window width={440} height={550} resizable>
      <Window.Content scrollable>
        <Section
          ...
          {!!data.secure && <NoticeBox>Secure Access: Please have your access card ready.</NoticeBox>}
          {(contents.length === 0 && <NoticeBox>Unfortunately, this {data.name} is empty.</NoticeBox>) || (
            <Table>
              <Table.Row header>
              ...
              {map((value, key) => (
                <Table.Row key={key}>
                  <Table.Cell>{value.display_name}</Table.Cell>
